...
#---expanding simulation data
# Load mapping data
file.path <- "/home/amirgazar/Paper2_Nov_2024/Datasets/demand_data_and_rep_days.csv"
...
folder_path <- "/projects/epadecarb/Decarb_Paper/Results/Rep_Days/"
...
folder_path <- "/projects/epadecarb/Decarb_Paper/Results/Summary/Rep_Days/Extended_Data/"
fwrite(Hourly_Results_NE_rep_days_ALL, file.path(folder_path, "Hourly_Results_Rep_Days_extended.csv"))
