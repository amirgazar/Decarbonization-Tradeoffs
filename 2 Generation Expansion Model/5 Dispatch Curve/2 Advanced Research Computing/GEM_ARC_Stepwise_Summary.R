...
# Load Capacity data
path <- "/projects/epadecarb/Decarb_Paper/Results/Stepwise"
files <- list.files(path = path, pattern = "\\.csv$", full.names = TRUE)

# Separate files based on type
facility_files <- grep("Facility_Level_Results_stepwise", files, value = TRUE)
hourly_files <- grep("Hourly_Results_NE_stepwise", files, value = TRUE)
...
process_facility_files <- function(chunk_files, chunk_index) {
  ...
  write.csv(Yearly_Facility_Level_Results, paste0("/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise/Yearly_Facility_Level_Results_Chunk_", chunk_index, ".csv"))
  ...
  write.csv(Monthly_Facility_Level_Results, paste0("/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise/Monthly_Facility_Level_Results_Chunk_", chunk_index, ".csv"))
}
...
process_hourly_files <- function(chunk_files, chunk_index) {
  ...
  write.csv(Yearly_Results, paste0("/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise/Yearly_Results_Chunk_", chunk_index, ".csv"))
  ...
  write.csv(Percentile_Results, paste0("/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise/Percentile_Results_Chunk_", chunk_index, ".csv"))
  ...
  write.csv(Logical_Results, paste0("/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise/Logical_Results_Chunk_", chunk_index, ".csv"))
  ...
  write.csv(Yearly_Results_Shortages, paste0("/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise/Yearly_Results_Shortages_Chunk_", chunk_index, ".csv"))
}
...
yearly_files <- list.files("/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise", pattern = "Yearly_Results_Chunk_.*\\.csv$", full.names = TRUE)
percentile_files <- list.files("/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise", pattern = "Percentile_Results_Chunk_.*\\.csv$", full.names = TRUE)
logical_files <- list.files("/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise", pattern = "Logical_Results_Chunk_.*\\.csv$", full.names = TRUE)
yearly_facility_files <- list.files("/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise", pattern = "Yearly_Facility_Level_Results_Chunk_.*\\.csv$", full.names = TRUE)
monthly_facility_files <- list.files("/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise", pattern = "Monthly_Facility_Level_Results_Chunk_.*\\.csv$", full.names = TRUE)
shortages_files <- list.files("/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise", pattern = "Yearly_Results_Shortages_Chunk_.*\\.csv$", full.names = TRUE)
...
write.csv(Yearly_Results, "/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise/Final/Yearly_Results.csv")
write.csv(Percentile_Results, "/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise/Final/Percentile_Results.csv")
write.csv(Logical_Results, "/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise/Final/Logical_Results.csv")
write.csv(Yearly_Facility_Level_Results, "/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise/Final/Yearly_Facility_Level_Results.csv")
write.csv(Monthly_Facility_Level_Results, "/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise/Final/Monthly_Facility_Level_Results.csv")
write.csv(Yearly_Results_Shortages, "/projects/epadecarb/Decarb_Paper/Results/Summary/Stepwise/Final/Yearly_Results_Shortages.csv")
