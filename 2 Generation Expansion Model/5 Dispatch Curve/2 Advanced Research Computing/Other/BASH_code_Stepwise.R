...
singularity exec --bind /work,/projects /projects/arcsingularity/ood-rstudio141717-basic_4.1.0.sif Rscript /projects/epadecarb/Decarb_Paper/GEM_ARC_Stepwise_1.R

module reset"

# Saving the BASH file
bash_file <- "GEM_Stepwise_1.sh"
