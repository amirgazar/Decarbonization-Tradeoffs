...
# Define the number of simulations
iteration <- 1
start_sim <- 4 + iteration
n_simulations <- 4 + iteration
...
hourly_results_file <- sprintf("/projects/epadecarb/Decarb_Paper/Results/Stepwise/Hourly_Results_NE_stepwise_%s_pathway_%s_iteration_%s.csv", timestamp, pathways, iteration)
facility_level_results_file <- sprintf("/projects/epadecarb/Decarb_Paper/Results/Stepwise/Facility_Level_Results_stepwise_%s_pathway_%s_iteration_%s.csv", timestamp, pathways, iteration)
