...
hourly_results_file <- sprintf("/home/amirgazar/Paper2_Nov_2024/Results/Rep_Days/Hourly_Results_NE_rep_days_%s_iteration_%s.csv", timestamp, iteration)
facility_level_results_file <- sprintf("/home/amirgazar/Paper2_Nov_2024/Results/Rep_Days/Facility_Level_Results_rep_days_%s_iteration_%s.csv", timestamp, iteration)
