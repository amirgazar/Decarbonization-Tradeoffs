...
hourly_chunks <- split(hourly_files, ceiling(seq_along(hourly_files) / 10))
...
process_facility_files <- function(chunk_files, chunk_index) {
  ...
  for (i in seq_along(chunk_files)) {
    ...
    data[, Simulation := i + (chunk_index - 1) * 10]  # Assign Simulation number
  ...
  write.csv(Yearly_Facility_Level_Results, paste0("/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized/Yearly_Facility_Level_Results_Chunk_", chunk_index, ".csv"))
  ...
  write.csv(Monthly_Facility_Level_Results, paste0("/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized/Monthly_Facility_Level_Results_Chunk_", chunk_index, ".csv"))
}
...
process_hourly_files <- function(chunk_files, chunk_index) {
  ...
  unit_columns <- grep("_MW$|_lbs$|_tons$", names(Hourly_Results), value = TRUE)
  ...
  write.csv(Yearly_Results, paste0("/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized/Yearly_Results_Chunk_", chunk_index, ".csv"))
  ...
  write.csv(Percentile_Results, paste0("/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized/Percentile_Results_Chunk_", chunk_index, ".csv"))
  ...
  write.csv(Logical_Results, paste0("/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized/Logical_Results_Chunk_", chunk_index, ".csv"))
  ...
  write.csv(Yearly_Results_Shortages, paste0("/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized/Yearly_Results_Shortages_Chunk_", chunk_index, ".csv"))
}
...
yearly_files <- list.files("/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized", pattern = "Yearly_Results_Chunk_.*\\.csv$", full.names = TRUE)
percentile_files <- list.files("/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized", pattern = "Percentile_Results_Chunk_.*\\.csv$", full.names = TRUE)
logical_files <- list.files("/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized", pattern = "Logical_Results_Chunk_.*\\.csv$", full.names = TRUE)
yearly_facility_files <- list.files("/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized", pattern = "Yearly_Facility_Level_Results_Chunk_.*\\.csv$", full.names = TRUE)
monthly_facility_files <- list.files("/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized", pattern = "Monthly_Facility_Level_Results_Chunk_.*\\.csv$", full.names = TRUE)
shortages_files <- list.files("/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized", pattern = "Yearly_Results_Shortages_Chunk_.*\\.csv$", full.names = TRUE)
...
write.csv(Yearly_Results, "/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized/Final/Yearly_Results.csv")
write.csv(Percentile_Results, "/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized/Final/Percentile_Results.csv")
write.csv(Logical_Results, "/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized/Final/Logical_Results.csv")
write.csv(Yearly_Facility_Level_Results, "/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized/Final/Yearly_Facility_Level_Results.csv")
write.csv(Monthly_Facility_Level_Results, "/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized/Final/Monthly_Facility_Level_Results.csv")
write.csv(Yearly_Results_Shortages, "/projects/epadecarb/2 Generation Expansion Model/4 Results/2 Stepwise Summarized/Final/Yearly_Results_Shortages.csv")
