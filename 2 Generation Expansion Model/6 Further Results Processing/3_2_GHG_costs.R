...
ce.BR = 
  read_csv('/Users/amirgazar/Documents/GitHub/Decarbonization-Tradeoffs/3 Total Costs/4 GHG Emissions Costs/bauer_and_rudebusch_term_structures.csv', show_col_types = F)[-1,] %>% 
  as.matrix

## read in RFF-SPs and calculate year-on-year growth rates
full.yoy.g =
  read_parquet('/Users/amirgazar/Documents/GitHub/Decarbonization-Tradeoffs/4 External Data/U.S. EPA SC/rffsp_global.parquet') %>% 
...
## export
results %>% 
  write_csv('/Users/amirgazar/Documents/GitHub/Decarbonization-Tradeoffs/3 Total Costs/4 GHG Emissions Costs/calibrated_rho_eta.csv')
